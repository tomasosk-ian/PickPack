      ...
      <section className="space-y-2">
        ...
        <Tabs defaultValue="tabla">
          <TabsList className="grid w-full grid-cols-3">
            ...
            <TabsTrigger value="povd">Porcentaje de Ocupación</TabsTrigger>
            <TabsTrigger value="to">Total de Ocupación</TabsTrigger>
          </TabsList>
          <TabsList className="grid w-full grid-cols-3">
            <TabsTrigger value="rpd">Reservas por día</TabsTrigger>
            <TabsTrigger value="fpd">Facturación por día</TabsTrigger>
            <TabsTrigger value="dpr">Duración Promedio</TabsTrigger>
          </TabsList>
