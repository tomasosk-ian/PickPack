...
export const sticEvtWebhookConfirmedOrderSchema = z.object({
  ...
  "RefNumber": z.number(),
  "ProductsTotalAmount": z.number(),
  "ProductDiscountsTotalAmount": z.number(),
  "ProductsSubTotalAmount": z.number(),
  "DiscountsTotalAmount": z.number(),
  ...
  "FinancingDiscountTotalAmount": z.number(),
  "TaxesAmount": z.number(),
  "ShippingAmount": z.number(),
  "TotalAmount": z.number(),
  "FinancedTotalAmount": z.number(),
  ...
  "Discount_Coupon_Id": z.number(),
  "Discount_Coupon_Name": z.string(),
  ...
  "Discount_Products_TotalSavings": z.number(),
  "OrderCreatedOn": z.string(),
  "Items": z.array(z.object({
    ...
    "Quantity": z.number(),
    "EffectiveTotalPrice": z.number(),
    "Discount_Individual_Id": z.number(),
    "Discount_Individual_CampaignId": z.number(),
    "Discount_Individual_TotalSavings": z.number(),
    ...
    "Discount_Collective_TotalSavings": z.number(),
